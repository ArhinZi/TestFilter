...
; 182  : 			pBufCtl->pBufEndAddr;
	...
	mov	rax, QWORD PTR [rax]
	sub	rax, rcx
	mov	QWORD PTR cbOverflow$28221[rsp], rax
...
; 186  : 		*ppAddress = pBufCtl->pBufStartAddr + cbOverflow;
	...
	mov	rcx, QWORD PTR pBufCtl$[rsp]
	mov	rcx, QWORD PTR [rcx]
	add	rcx, QWORD PTR cbOverflow$28221[rsp]
	mov	rax, QWORD PTR ppAddress$[rsp]
	mov	QWORD PTR [rax], rcx
$LN1@CBMovePtrF:
...
; 121  : 	for (INT i = 0; i < sizeof OldestHdr; i++) {
	...
	mov	DWORD PTR i$28189[rsp], 0
	jmp	SHORT $LN3@CBFreeOlde
$LN2@CBFreeOlde:
	mov	eax, DWORD PTR i$28189[rsp]
	add	eax, 1
	mov	DWORD PTR i$28189[rsp], eax
$LN3@CBFreeOlde:
	movsxd	rax, DWORD PTR i$28189[rsp]
	cmp	rax, 8
	jae	SHORT $LN1@CBFreeOlde

; 122  : 		*(pHdrVar + i) = *pHdr;

	movsxd	rdx, DWORD PTR i$28189[rsp]
...
; 87   : 	for (INT i = 0; i < sizeof blockHdr; i++) {
	...
	mov	DWORD PTR i$28173[rsp], 0
	jmp	SHORT $LN3@CBAllocate
$LN2@CBAllocate:
	mov	eax, DWORD PTR i$28173[rsp]
	add	eax, 1
	mov	DWORD PTR i$28173[rsp], eax
$LN3@CBAllocate:
	movsxd	rax, DWORD PTR i$28173[rsp]
	cmp	rax, 8
	jae	SHORT $LN1@CBAllocate

; 88   : 		*pBlockStart = *(pHdr + i);

	movsxd	rdx, DWORD PTR i$28173[rsp]
...
; 300  : 	for (INT i = 0; i < sizeof blkHdr; i++) {
	...
	mov	DWORD PTR i$28268[rsp], 0
	jmp	SHORT $LN12@CBXtractFr
$LN11@CBXtractFr:
	mov	eax, DWORD PTR i$28268[rsp]
	add	eax, 1
	mov	DWORD PTR i$28268[rsp], eax
$LN12@CBXtractFr:
	movsxd	rax, DWORD PTR i$28268[rsp]
	cmp	rax, 8
	jae	SHORT $LN10@CBXtractFr

; 301  : 		*(pHdrVar + i) = *pHdr;

	movsxd	rdx, DWORD PTR i$28268[rsp]
	mov	rcx, QWORD PTR pHdrVar$[rsp]
	mov	rax, QWORD PTR pHdr$[rsp]
	movzx	eax, BYTE PTR [rax]
	mov	BYTE PTR [rcx+rdx], al
...
; 211  : 	for (INT i = 0; i < sizeof curBlockHdr; i++) {
	...
	mov	DWORD PTR i$28236[rsp], 0
	jmp	SHORT $LN8@CBStore
$LN7@CBStore:
	mov	eax, DWORD PTR i$28236[rsp]
	add	eax, 1
	mov	DWORD PTR i$28236[rsp], eax
$LN8@CBStore:
	movsxd	rax, DWORD PTR i$28236[rsp]
	cmp	rax, 8
	jae	SHORT $LN6@CBStore

; 212  : 		*(pHdrVar + i) = *pHdr;

	movsxd	rdx, DWORD PTR i$28236[rsp]
	mov	rcx, QWORD PTR pHdrVar$[rsp]
	mov	rax, QWORD PTR pHdr$[rsp]
	movzx	eax, BYTE PTR [rax]
	mov	BYTE PTR [rcx+rdx], al
