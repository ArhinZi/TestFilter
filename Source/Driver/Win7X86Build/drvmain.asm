...
PUBLIC	??_C@_08FJEJKIGF@11?307?307?$AA@FNODOBFM@	;  ?? ::FNODOBFM::`string'
...
text$s	ENDS
;	COMDAT ??_C@_08FJEJKIGF@11?307?307?$AA@FNODOBFM@
text$s	SEGMENT
??_C@_08FJEJKIGF@11?307?307?$AA@FNODOBFM@ DB '11:07:07', 00H ;  ?? ::FNODOBFM::`string'
...
; 474  : 		"%s %s\n\n",__DATE__, __TIME__);
	...
	push	OFFSET ??_C@_08FJEJKIGF@11?307?307?$AA@FNODOBFM@
...
; 561  : 	for (int i = 0; i < IRP_MJ_MAXIMUM_FUNCTION + 1; i++) 
	...
	mov	DWORD PTR _i$28358[ebp], 0
	jmp	SHORT $LN13@AddDevice
$LN12@AddDevice:
	mov	ecx, DWORD PTR _i$28358[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$28358[ebp], ecx
$LN13@AddDevice:
	cmp	DWORD PTR _i$28358[ebp], 28		; 0000001cH
	jge	SHORT $LN11@AddDevice

; 562  : 		pDevExt->dwMJFlags[i] = MJ_FLAGS_DEFAULT;

	mov	edx, DWORD PTR _i$28358[ebp]
	mov	eax, DWORD PTR _pDevExt$[ebp]
...
; 978  : 		ULONG StrCharLen = uSymName.Length / sizeof (WCHAR) - 4;
	...
	shr	ecx, 1
	sub	ecx, 4
	mov	DWORD PTR _StrCharLen$28489[ebp], ecx

; 979  : 		ULONG i = 0;

	mov	DWORD PTR _i$28491[ebp], 0

; 980  : 		for (; i < StrCharLen; i++) {

	jmp	SHORT $LN7@CreateDevi
$LN6@CreateDevi:
	mov	edx, DWORD PTR _i$28491[ebp]
	add	edx, 1
	mov	DWORD PTR _i$28491[ebp], edx
$LN7@CreateDevi:
	mov	eax, DWORD PTR _i$28491[ebp]
	cmp	eax, DWORD PTR _StrCharLen$28489[ebp]
	jae	SHORT $LN5@CreateDevi

; 981  : 			pwszSymLink[i] = uSymName.Buffer[i + 4];

	mov	ecx, DWORD PTR _i$28491[ebp]
...
_TEXT	SEGMENT
_argList$27444 = -20					; size = 4
_cchNewDestLength$27445 = -16				; size = 4
_cchDest$ = -12						; size = 4
_status$ = -8						; size = 4
_pszDest$ = -4						; size = 4
...
; 11147:         size_t cchNewDestLength = 0;
	...
	mov	DWORD PTR _cchNewDestLength$27445[ebp], 0

; 11148: 
; 11149:         va_start(argList, pszFormat);

	lea	eax, DWORD PTR _pszFormat$[ebp+4]
	mov	DWORD PTR _argList$27444[ebp], eax
...
; 11155:                                                argList);
	...
	mov	ecx, DWORD PTR _argList$27444[ebp]
	push	ecx
	mov	edx, DWORD PTR _pszFormat$[ebp]
	push	edx
	lea	eax, DWORD PTR _cchNewDestLength$27445[ebp]
	push	eax
...
; 11157:         va_end(argList);
	...
	mov	DWORD PTR _argList$27444[ebp], 0
...
; 11160:         DestinationString->Length = (USHORT)(cchNewDestLength * sizeof(wchar_t));
	...
	mov	eax, DWORD PTR _cchNewDestLength$27445[ebp]
	shl	eax, 1
...
_TEXT	SEGMENT
_pItem$28583 = -28					; size = 4
_pIrp$28584 = -24					; size = 4
_pDevExt$ = -20						; size = 4
_pWCompl$ = -16						; size = 4
...
; 1329 : 		PLIST_ENTRY pItem = RemoveHeadList(pWCompl);
	...
	mov	DWORD PTR _pItem$28583[ebp], eax
...
; 1332 : 			CONTAINING_RECORD(pItem, IRP, Tail.Overlay.ListEntry);
	...
	mov	edx, DWORD PTR _pItem$28583[ebp]
	sub	edx, 88					; 00000058H
	mov	DWORD PTR _pIrp$28584[ebp], edx

; 1333 : 
; 1334 : 		IoSetCancelRoutine(pIrp, NULL);

	xor	eax, eax
	mov	ecx, DWORD PTR _pIrp$28584[ebp]
...
; 1339 : 			"completed\n", pIrp);
	...
	mov	edx, DWORD PTR _pIrp$28584[ebp]
	push	edx
...
; 1221 : 		PIO_STACK_LOCATION pIrpStack = IoGetCurrentIrpStackLocation(pIrp);
	...
	push	ecx
	call	_IoGetCurrentIrpStackLocation@4
	mov	DWORD PTR _pIrpStack$28553[ebp], eax
...
; 1228 : 		);
	...
	mov	ecx, DWORD PTR _pIrpStack$28553[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	mov	eax, DWORD PTR _pIrpStack$28553[ebp]
...
_TEXT	SEGMENT
_pWriteData$28566 = -28					; size = 4
_LockHandle$28568 = -24					; size = 12
_pStack$28563 = -12					; size = 4
_cbDataLen$28567 = -8					; size = 4
_pDevExt$ = -4						; size = 4
_pDevObj$ = 8						; size = 4
_pIrp$ = 12						; size = 4
...
; 1271 : 		PIO_STACK_LOCATION pStack = IoGetCurrentIrpStackLocation(pIrp);
	...
	push	ecx
	call	_IoGetCurrentIrpStackLocation@4
	mov	DWORD PTR _pStack$28563[ebp], eax
...
; 1275 : 			pStack->Parameters.Write.Length);
	...
	mov	ecx, DWORD PTR _pStack$28563[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
...
; 1281 : 		GetWriteData(pIrp, pDevExt, &pWriteData, &cbDataLen);
	...
	lea	eax, DWORD PTR _cbDataLen$28567[ebp]
	push	eax
	lea	ecx, DWORD PTR _pWriteData$28566[ebp]
	push	ecx
	mov	edx, DWORD PTR _pDevExt$[ebp]
	push	edx
	mov	eax, DWORD PTR _pIrp$[ebp]
...
; 1285 : 			&LockHandle);
	...
	mov	ecx, DWORD PTR _pDevExt$[ebp]
	add	ecx, 68					; 00000044H
	lea	edx, DWORD PTR _LockHandle$28568[ebp]
	call	DWORD PTR __imp_@KeAcquireInStackQueuedSpinLock@8
...
; 1286 : 		InterceptIrpAndData(pIrp, pWriteData, cbDataLen, pDevExt);
	...
	mov	ecx, DWORD PTR _pDevExt$[ebp]
	push	ecx
	mov	edx, DWORD PTR _cbDataLen$28567[ebp]
	push	edx
	mov	eax, DWORD PTR _pWriteData$28566[ebp]
	push	eax
	mov	ecx, DWORD PTR _pIrp$[ebp]
	push	ecx
...
; 1288 : 		KeReleaseInStackQueuedSpinLock(&LockHandle);
	...
	lea	ecx, DWORD PTR _LockHandle$28568[ebp]
	call	DWORD PTR __imp_@KeReleaseInStackQueuedSpinLock@4
$LN1@DispatchFi@2:
...
_TEXT	SEGMENT
tv87 = -16						; size = 4
_pBufStart$28828 = -12					; size = 4
_pMdl$28827 = -8					; size = 4
_pStack$ = -4						; size = 4
_pIrp$ = 8						; size = 4
_pDevExt$ = 12						; size = 4
...
$LN8@GetWriteDa:
	...
	push	1
	push	0
	mov	ecx, DWORD PTR _pMdl$28827[ebp]
	push	ecx
	call	DWORD PTR __imp__MmMapLockedPagesSpecifyCache@24
	mov	DWORD PTR tv87[ebp], eax
$LN9@GetWriteDa:
	mov	edx, DWORD PTR tv87[ebp]
	mov	DWORD PTR _pBufStart$28828[ebp], edx

; 2192 : 		if (pBufStart != NULL) {

	cmp	DWORD PTR _pBufStart$28828[ebp], 0
	je	SHORT $LN3@GetWriteDa

; 2193 : 			*ppWriteData = pBufStart;

	mov	eax, DWORD PTR _ppWriteData$[ebp]
	mov	ecx, DWORD PTR _pBufStart$28828[ebp]
	mov	DWORD PTR [eax], ecx
...
; 2481 : 		for (INT i = 0; i < IRP_MJ_MAXIMUM_FUNCTION; i++) {
	...
	mov	DWORD PTR _i$28914[ebp], 0
	jmp	SHORT $LN6@IoctlSetMJ
$LN5@IoctlSetMJ:
	mov	edx, DWORD PTR _i$28914[ebp]
	add	edx, 1
	mov	DWORD PTR _i$28914[ebp], edx
$LN6@IoctlSetMJ:
	cmp	DWORD PTR _i$28914[ebp], 27		; 0000001bH
	jge	SHORT $LN4@IoctlSetMJ

; 2482 : 			pFltDevExt->dwMJFlags[i] = pNewFlags->dwFlags;

	mov	eax, DWORD PTR _i$28914[ebp]
	mov	ecx, DWORD PTR _pFltDevExt$[ebp]
	mov	edx, DWORD PTR _pNewFlags$[ebp]
...
; 2620 : 	for (ULONG i = 0; i < pAdl->DevInfoCount; i++) {
	...
	mov	DWORD PTR _i$28970[ebp], 0
	jmp	SHORT $LN3@MADispatch
$LN2@MADispatch:
	mov	edx, DWORD PTR _i$28970[ebp]
	add	edx, 1
	mov	DWORD PTR _i$28970[ebp], edx
$LN3@MADispatch:
	mov	eax, DWORD PTR _pAdl$[ebp]
	mov	ecx, DWORD PTR _i$28970[ebp]
...
; 2623 : 				ListEntry);
	...
	mov	DWORD PTR _pFADevExt$28974[ebp], edx

; 2624 : 		pAdl->TargDevVect[i] = pFADevExt->TargDevInfo;

	mov	esi, DWORD PTR _pFADevExt$28974[ebp]
	add	esi, 12					; 0000000cH
	mov	eax, DWORD PTR _i$28970[ebp]
...
; 1862 : 		PMDL pMdl = pIrp->MdlAddress;
	...
	mov	ecx, DWORD PTR _pIrp$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR _pMdl$28750[ebp], edx

; 1863 : 		*ppBuffer = 
; 1864 : 			MmGetSystemAddressForMdlSafe(pMdl, LowPagePriority);

	mov	eax, DWORD PTR _pMdl$28750[ebp]
	movsx	ecx, WORD PTR [eax+6]
	and	ecx, 5
	je	SHORT $LN8@GetRWIrpBu
	mov	edx, DWORD PTR _pMdl$28750[ebp]
	mov	eax, DWORD PTR [edx+12]
...
$LN8@GetRWIrpBu:
	...
	push	1
	push	0
	mov	ecx, DWORD PTR _pMdl$28750[ebp]
	push	ecx
	call	DWORD PTR __imp__MmMapLockedPagesSpecifyCache@24
	mov	DWORD PTR tv85[ebp], eax
$LN9@GetRWIrpBu:
...
_TEXT	SEGMENT
_pReadData$29081 = -24					; size = 4
_LockHandle$29083 = -20					; size = 12
_cbReadDataLen$29082 = -8				; size = 4
_pDevExt$ = -4						; size = 4
_pDevObj$ = 8						; size = 4
_pIrp$ = 12						; size = 4
_pContext$ = 16						; size = 4
...
; 3079 : 		GetReadData(pIrp, pDevExt, &pReadData, &cbReadDataLen);
	...
	lea	ecx, DWORD PTR _cbReadDataLen$29082[ebp]
	push	ecx
	lea	edx, DWORD PTR _pReadData$29081[ebp]
	push	edx
	mov	eax, DWORD PTR _pDevExt$[ebp]
	push	eax
	mov	ecx, DWORD PTR _pIrp$[ebp]
...
; 3084 : 			&LockHandle);
	...
	mov	ecx, DWORD PTR _pDevExt$[ebp]
	add	ecx, 68					; 00000044H
	lea	edx, DWORD PTR _LockHandle$29083[ebp]
	call	DWORD PTR __imp_@KeAcquireInStackQueuedSpinLock@8
...
; 3085 : 		InterceptIrpAndData(pIrp, pReadData, cbReadDataLen, pDevExt);
	...
	mov	edx, DWORD PTR _pDevExt$[ebp]
	push	edx
	mov	eax, DWORD PTR _cbReadDataLen$29082[ebp]
	push	eax
	mov	ecx, DWORD PTR _pReadData$29081[ebp]
	push	ecx
	mov	edx, DWORD PTR _pIrp$[ebp]
	push	edx
	call	?InterceptIrpAndData@@YGXPAU_IRP@@PAXKPAU_DEVICE_EXTENSION@@@Z ; InterceptIrpAndData
...
; 3087 : 		KeReleaseInStackQueuedSpinLock(&LockHandle);
	...
	lea	ecx, DWORD PTR _LockHandle$29083[ebp]
	call	DWORD PTR __imp_@KeReleaseInStackQueuedSpinLock@4
$LN2@ReadComple:
...
_TEXT	SEGMENT
tv87 = -12						; size = 4
_pBufStart$28735 = -8					; size = 4
_pMdl$28734 = -4					; size = 4
_pReadIrp$ = 8						; size = 4
_pDevExt$ = 12						; size = 4
...
$LN9@GetReadDat:
	...
	push	1
	push	0
	mov	ecx, DWORD PTR _pMdl$28734[ebp]
	push	ecx
	call	DWORD PTR __imp__MmMapLockedPagesSpecifyCache@24
	mov	DWORD PTR tv87[ebp], eax
$LN10@GetReadDat:
	mov	edx, DWORD PTR tv87[ebp]
	mov	DWORD PTR _pBufStart$28735[ebp], edx

; 1807 : 		if (pBufStart != NULL) {

	cmp	DWORD PTR _pBufStart$28735[ebp], 0
	je	SHORT $LN3@GetReadDat

; 1808 : 			*ppReadData = pBufStart;

	mov	eax, DWORD PTR _ppReadData$[ebp]
	mov	ecx, DWORD PTR _pBufStart$28735[ebp]
	mov	DWORD PTR [eax], ecx
...
_TEXT	SEGMENT
_pFirst$29094 = -12					; size = 4
_pClientIrp$29095 = -8					; size = 4
_pIrpList$ = -4						; size = 4
_pDevExt$ = 8						; size = 4
...
; 3123 : 		PLIST_ENTRY pFirst = RemoveHeadList(pIrpList);
	...
	push	edx
	call	_RemoveHeadList@4
	mov	DWORD PTR _pFirst$29094[ebp], eax
...
; 3143 : 			Tail.Overlay.ListEntry);
	...
	mov	eax, DWORD PTR _pFirst$29094[ebp]
	sub	eax, 88					; 00000058H
	mov	DWORD PTR _pClientIrp$29095[ebp], eax
...
; 3147 : 			pClientIrp);
	...
	mov	ecx, DWORD PTR _pClientIrp$29095[ebp]
	push	ecx
...
; 3149 : 		MoveIrpDataToCltIrp(pDevExt, pClientIrp);
	...
	mov	edx, DWORD PTR _pClientIrp$29095[ebp]
	push	edx
	mov	eax, DWORD PTR _pDevExt$[ebp]
	push	eax
...
; 4513 :         va_start(argList, pszFormat);
	...
	lea	eax, DWORD PTR _pszFormat$[ebp+4]
	mov	DWORD PTR _argList$25940[ebp], eax
...
; 4519 :                                   argList);
	...
	mov	ecx, DWORD PTR _argList$25940[ebp]
	push	ecx
	mov	edx, DWORD PTR _pszFormat$[ebp]
	push	edx
	push	0
...
; 4521 :         va_end(argList);
	...
	mov	DWORD PTR _argList$25940[ebp], 0
$LN1@RtlStringC@2:
