...
; 87   : 	for (INT i = 0; i < sizeof blockHdr; i++) {
	...
	mov	DWORD PTR _i$25869[ebp], 0
	jmp	SHORT $LN3@CBAllocate
$LN2@CBAllocate:
	mov	edx, DWORD PTR _i$25869[ebp]
	add	edx, 1
	mov	DWORD PTR _i$25869[ebp], edx
$LN3@CBAllocate:
	cmp	DWORD PTR _i$25869[ebp], 4
	jae	SHORT $LN1@CBAllocate

; 88   : 		*pBlockStart = *(pHdr + i);

	mov	eax, DWORD PTR _pHdr$[ebp]
	add	eax, DWORD PTR _i$25869[ebp]
...
; 121  : 	for (INT i = 0; i < sizeof OldestHdr; i++) {
	...
	mov	DWORD PTR _i$25885[ebp], 0
	jmp	SHORT $LN3@CBFreeOlde
$LN2@CBFreeOlde:
	mov	edx, DWORD PTR _i$25885[ebp]
	add	edx, 1
	mov	DWORD PTR _i$25885[ebp], edx
$LN3@CBFreeOlde:
	cmp	DWORD PTR _i$25885[ebp], 4
	jae	SHORT $LN1@CBFreeOlde

; 122  : 		*(pHdrVar + i) = *pHdr;

	mov	eax, DWORD PTR _pHdrVar$[ebp]
	add	eax, DWORD PTR _i$25885[ebp]
...
; 182  : 			pBufCtl->pBufEndAddr;
	...
	mov	DWORD PTR _cbOverflow$25917[ebp], edx
...
; 186  : 		*ppAddress = pBufCtl->pBufStartAddr + cbOverflow;
	...
	mov	eax, DWORD PTR _pBufCtl$[ebp]
	mov	ecx, DWORD PTR [eax]
	add	ecx, DWORD PTR _cbOverflow$25917[ebp]
	mov	edx, DWORD PTR _ppAddress$[ebp]
	mov	DWORD PTR [edx], ecx
$LN1@CBMovePtrF:
...
; 211  : 	for (INT i = 0; i < sizeof curBlockHdr; i++) {
	...
	mov	DWORD PTR _i$25932[ebp], 0
	jmp	SHORT $LN8@CBStore
$LN7@CBStore:
	mov	edx, DWORD PTR _i$25932[ebp]
	add	edx, 1
	mov	DWORD PTR _i$25932[ebp], edx
$LN8@CBStore:
	cmp	DWORD PTR _i$25932[ebp], 4
	jae	SHORT $LN6@CBStore

; 212  : 		*(pHdrVar + i) = *pHdr;

	mov	eax, DWORD PTR _pHdrVar$[ebp]
	add	eax, DWORD PTR _i$25932[ebp]
	mov	ecx, DWORD PTR _pHdr$[ebp]
	mov	dl, BYTE PTR [ecx]
	mov	BYTE PTR [eax], dl
...
; 300  : 	for (INT i = 0; i < sizeof blkHdr; i++) {
	...
	mov	DWORD PTR _i$25964[ebp], 0
	jmp	SHORT $LN12@CBXtractFr
$LN11@CBXtractFr:
	mov	edx, DWORD PTR _i$25964[ebp]
	add	edx, 1
	mov	DWORD PTR _i$25964[ebp], edx
$LN12@CBXtractFr:
	cmp	DWORD PTR _i$25964[ebp], 4
	jae	SHORT $LN10@CBXtractFr

; 301  : 		*(pHdrVar + i) = *pHdr;

	mov	eax, DWORD PTR _pHdrVar$[ebp]
	add	eax, DWORD PTR _i$25964[ebp]
	mov	ecx, DWORD PTR _pHdr$[ebp]
	mov	dl, BYTE PTR [ecx]
	mov	BYTE PTR [eax], dl
