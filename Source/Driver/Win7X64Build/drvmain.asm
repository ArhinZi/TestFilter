...
PUBLIC	??_C@_08GLMBMFBO@11?305?340?$AA@FNODOBFM@	;  ?? ::FNODOBFM::`string'
...
text$s	ENDS
;	COMDAT ??_C@_08GLMBMFBO@11?305?340?$AA@FNODOBFM@
text$s	SEGMENT
??_C@_08GLMBMFBO@11?305?340?$AA@FNODOBFM@ DB '11:05:40', 00H ;  ?? ::FNODOBFM::`string'
text$s	ENDS
...
; 1862 : 		PMDL pMdl = pIrp->MdlAddress;
	...
	mov	QWORD PTR pMdl$29276[rsp], rax

; 1863 : 		*ppBuffer = 
; 1864 : 			MmGetSystemAddressForMdlSafe(pMdl, LowPagePriority);

	mov	rax, QWORD PTR pMdl$29276[rsp]
...
$LN8@GetRWIrpBu:
	...
	mov	r8d, 1
	xor	edx, edx
	mov	rcx, QWORD PTR pMdl$29276[rsp]
...
$LN9@GetReadDat:
	...
	mov	r8d, 1
	xor	edx, edx
	mov	rcx, QWORD PTR pMdl$29260[rsp]
	call	QWORD PTR __imp_MmMapLockedPagesSpecifyCache
	mov	QWORD PTR tv87[rsp], rax
$LN10@GetReadDat:
	mov	rax, QWORD PTR tv87[rsp]
	mov	QWORD PTR pBufStart$29261[rsp], rax

; 1807 : 		if (pBufStart != NULL) {

	cmp	QWORD PTR pBufStart$29261[rsp], 0
	je	SHORT $LN3@GetReadDat

; 1808 : 			*ppReadData = pBufStart;

	mov	rcx, QWORD PTR ppReadData$[rsp]
	mov	rax, QWORD PTR pBufStart$29261[rsp]
	mov	QWORD PTR [rcx], rax
...
; 4513 :         va_start(argList, pszFormat);
	...
	mov	QWORD PTR argList$26457[rsp], rax
...
; 4519 :                                   argList);
	...
	mov	rax, QWORD PTR argList$26457[rsp]
	mov	QWORD PTR [rsp+32], rax
...
; 4521 :         va_end(argList);
	...
	mov	QWORD PTR argList$26457[rsp], 0
$LN1@RtlStringC@2:
...
; 2481 : 		for (INT i = 0; i < IRP_MJ_MAXIMUM_FUNCTION; i++) {
	...
	mov	DWORD PTR i$29440[rsp], 0
	jmp	SHORT $LN6@IoctlSetMJ
$LN5@IoctlSetMJ:
	mov	eax, DWORD PTR i$29440[rsp]
	add	eax, 1
	mov	DWORD PTR i$29440[rsp], eax
$LN6@IoctlSetMJ:
	cmp	DWORD PTR i$29440[rsp], 27
	jge	SHORT $LN4@IoctlSetMJ

; 2482 : 			pFltDevExt->dwMJFlags[i] = pNewFlags->dwFlags;

	movsxd	rdx, DWORD PTR i$29440[rsp]
...
$LN8@GetWriteDa:
	...
	mov	r8d, 1
	xor	edx, edx
	mov	rcx, QWORD PTR pMdl$29353[rsp]
	call	QWORD PTR __imp_MmMapLockedPagesSpecifyCache
	mov	QWORD PTR tv88[rsp], rax
$LN9@GetWriteDa:
	mov	rax, QWORD PTR tv88[rsp]
	mov	QWORD PTR pBufStart$29354[rsp], rax

; 2192 : 		if (pBufStart != NULL) {

	cmp	QWORD PTR pBufStart$29354[rsp], 0
	je	SHORT $LN3@GetWriteDa

; 2193 : 			*ppWriteData = pBufStart;

	mov	rcx, QWORD PTR ppWriteData$[rsp]
	mov	rax, QWORD PTR pBufStart$29354[rsp]
	mov	QWORD PTR [rcx], rax
...
; 1329 : 		PLIST_ENTRY pItem = RemoveHeadList(pWCompl);
	...
	mov	rcx, QWORD PTR pWCompl$[rsp]
	call	RemoveHeadList
	mov	QWORD PTR pItem$29115[rsp], rax
...
; 1332 : 			CONTAINING_RECORD(pItem, IRP, Tail.Overlay.ListEntry);
	...
	mov	rax, QWORD PTR pItem$29115[rsp]
	sub	rax, 168				; 000000a8H
	mov	QWORD PTR pIrp$29116[rsp], rax

; 1333 : 
; 1334 : 		IoSetCancelRoutine(pIrp, NULL);

	mov	rax, QWORD PTR pIrp$29116[rsp]
...
; 1335 : 		IoCompleteRequest(pIrp, IO_NO_INCREMENT);
	...
	xor	edx, edx
	mov	rcx, QWORD PTR pIrp$29116[rsp]
	call	QWORD PTR __imp_IofCompleteRequest
...
; 1339 : 			"completed\n", pIrp);
	...
	mov	r9, QWORD PTR pIrp$29116[rsp]
...
; 11147:         size_t cchNewDestLength = 0;
	...
	mov	QWORD PTR cchNewDestLength$27968[rsp], 0

; 11148: 
; 11149:         va_start(argList, pszFormat);

	lea	rax, QWORD PTR pszFormat$[rsp+8]
	mov	QWORD PTR argList$27967[rsp], rax
...
; 11155:                                                argList);
	...
	mov	rax, QWORD PTR argList$27967[rsp]
	mov	QWORD PTR [rsp+32], rax
	mov	r9, QWORD PTR pszFormat$[rsp]
	lea	r8, QWORD PTR cchNewDestLength$27968[rsp]
	mov	rdx, QWORD PTR cchDest$[rsp]
	mov	rcx, QWORD PTR pszDest$[rsp]
...
; 11157:         va_end(argList);
	...
	mov	QWORD PTR argList$27967[rsp], 0
...
; 11160:         DestinationString->Length = (USHORT)(cchNewDestLength * sizeof(wchar_t));
	...
	mov	rcx, QWORD PTR cchNewDestLength$27968[rsp]
	shl	rcx, 1
	mov	rax, QWORD PTR DestinationString$[rsp]
	mov	WORD PTR [rax], cx
$LN1@RtlUnicode@3:
...
; 3123 : 		PLIST_ENTRY pFirst = RemoveHeadList(pIrpList);
	...
	mov	rcx, QWORD PTR pIrpList$[rsp]
	call	RemoveHeadList
	mov	QWORD PTR pFirst$29617[rsp], rax
...
; 3143 : 			Tail.Overlay.ListEntry);
	...
	mov	rax, QWORD PTR pFirst$29617[rsp]
	sub	rax, 168				; 000000a8H
	mov	QWORD PTR pClientIrp$29618[rsp], rax
...
; 3147 : 			pClientIrp);
	...
	mov	r9, QWORD PTR pClientIrp$29618[rsp]
...
; 3149 : 		MoveIrpDataToCltIrp(pDevExt, pClientIrp);
	...
	mov	rdx, QWORD PTR pClientIrp$29618[rsp]
	mov	rcx, QWORD PTR pDevExt$[rsp]
...
; 2620 : 	for (ULONG i = 0; i < pAdl->DevInfoCount; i++) {
	...
	mov	DWORD PTR i$29496[rsp], 0
	jmp	SHORT $LN3@MADispatch
$LN2@MADispatch:
	mov	eax, DWORD PTR i$29496[rsp]
	add	eax, 1
	mov	DWORD PTR i$29496[rsp], eax
$LN3@MADispatch:
	mov	rax, QWORD PTR pAdl$[rsp]
	mov	eax, DWORD PTR [rax+4]
	cmp	DWORD PTR i$29496[rsp], eax
...
; 2623 : 				ListEntry);
	...
	mov	QWORD PTR pFADevExt$29500[rsp], rax

; 2624 : 		pAdl->TargDevVect[i] = pFADevExt->TargDevInfo;

	lea	rdi, QWORD PTR $T31084[rsp]
	mov	rsi, QWORD PTR pFADevExt$29500[rsp]
	add	rsi, 24
	mov	ecx, 1114				; 0000045aH
	rep movsb
	mov	ecx, DWORD PTR i$29496[rsp]
	imul	rcx, 1114				; 0000045aH
	mov	rax, QWORD PTR pAdl$[rsp]
	lea	rsi, QWORD PTR $T31084[rsp]
...
; 978  : 		ULONG StrCharLen = uSymName.Length / sizeof (WCHAR) - 4;
	...
	div	rcx
	sub	rax, 4
	mov	DWORD PTR StrCharLen$29021[rsp], eax

; 979  : 		ULONG i = 0;

	mov	DWORD PTR i$29023[rsp], 0

; 980  : 		for (; i < StrCharLen; i++) {

	jmp	SHORT $LN7@CreateDevi
$LN6@CreateDevi:
	mov	eax, DWORD PTR i$29023[rsp]
	add	eax, 1
	mov	DWORD PTR i$29023[rsp], eax
$LN7@CreateDevi:
	mov	eax, DWORD PTR StrCharLen$29021[rsp]
	cmp	DWORD PTR i$29023[rsp], eax
...
; 561  : 	for (int i = 0; i < IRP_MJ_MAXIMUM_FUNCTION + 1; i++) 
	...
	mov	DWORD PTR i$28890[rsp], 0
	jmp	SHORT $LN13@AddDevice
$LN12@AddDevice:
	mov	eax, DWORD PTR i$28890[rsp]
	add	eax, 1
	mov	DWORD PTR i$28890[rsp], eax
$LN13@AddDevice:
	cmp	DWORD PTR i$28890[rsp], 28
	jge	SHORT $LN11@AddDevice

; 562  : 		pDevExt->dwMJFlags[i] = MJ_FLAGS_DEFAULT;

	movsxd	rcx, DWORD PTR i$28890[rsp]
	mov	rax, QWORD PTR pDevExt$[rsp]
...
; 3079 : 		GetReadData(pIrp, pDevExt, &pReadData, &cbReadDataLen);
	...
	lea	r9, QWORD PTR cbReadDataLen$29605[rsp]
	lea	r8, QWORD PTR pReadData$29604[rsp]
	mov	rdx, QWORD PTR pDevExt$[rsp]
	mov	rcx, QWORD PTR pIrp$[rsp]
...
; 3084 : 			&LockHandle);
	...
	mov	rcx, QWORD PTR pDevExt$[rsp]
	add	rcx, 136				; 00000088H
	lea	rdx, QWORD PTR LockHandle$29606[rsp]
	call	QWORD PTR __imp_KeAcquireInStackQueuedSpinLock

; 3085 : 		InterceptIrpAndData(pIrp, pReadData, cbReadDataLen, pDevExt);

	mov	r9, QWORD PTR pDevExt$[rsp]
	mov	r8, QWORD PTR cbReadDataLen$29605[rsp]
	mov	rdx, QWORD PTR pReadData$29604[rsp]
	mov	rcx, QWORD PTR pIrp$[rsp]
...
; 3087 : 		KeReleaseInStackQueuedSpinLock(&LockHandle);
	...
	lea	rcx, QWORD PTR LockHandle$29606[rsp]
	call	QWORD PTR __imp_KeReleaseInStackQueuedSpinLock
$LN2@ReadComple:
...
; 1271 : 		PIO_STACK_LOCATION pStack = IoGetCurrentIrpStackLocation(pIrp);
	...
	mov	rcx, QWORD PTR pIrp$[rsp]
	call	IoGetCurrentIrpStackLocation
	mov	QWORD PTR pStack$29095[rsp], rax
...
; 1275 : 			pStack->Parameters.Write.Length);
	...
	mov	r11, QWORD PTR pStack$29095[rsp]
...
; 1281 : 		GetWriteData(pIrp, pDevExt, &pWriteData, &cbDataLen);
	...
	lea	r9, QWORD PTR cbDataLen$29099[rsp]
	lea	r8, QWORD PTR pWriteData$29098[rsp]
	mov	rdx, QWORD PTR pDevExt$[rsp]
	mov	rcx, QWORD PTR pIrp$[rsp]
...
; 1285 : 			&LockHandle);
	...
	mov	rcx, QWORD PTR pDevExt$[rsp]
	add	rcx, 136				; 00000088H
	lea	rdx, QWORD PTR LockHandle$29100[rsp]
	call	QWORD PTR __imp_KeAcquireInStackQueuedSpinLock

; 1286 : 		InterceptIrpAndData(pIrp, pWriteData, cbDataLen, pDevExt);

	mov	r9, QWORD PTR pDevExt$[rsp]
	mov	r8, QWORD PTR cbDataLen$29099[rsp]
	mov	rdx, QWORD PTR pWriteData$29098[rsp]
	mov	rcx, QWORD PTR pIrp$[rsp]
	call	?InterceptIrpAndData@@YAXPEAU_IRP@@PEAX_KPEAU_DEVICE_EXTENSION@@@Z ; InterceptIrpAndData
...
; 1288 : 		KeReleaseInStackQueuedSpinLock(&LockHandle);
	...
	lea	rcx, QWORD PTR LockHandle$29100[rsp]
	call	QWORD PTR __imp_KeReleaseInStackQueuedSpinLock
$LN1@DispatchFi:
...
; 1221 : 		PIO_STACK_LOCATION pIrpStack = IoGetCurrentIrpStackLocation(pIrp);
	...
	mov	rcx, QWORD PTR pIrp$[rsp]
	call	IoGetCurrentIrpStackLocation
	mov	QWORD PTR pIrpStack$29085[rsp], rax
...
; 1228 : 		);
	...
	mov	r11, QWORD PTR pIrpStack$29085[rsp]
	mov	eax, DWORD PTR [r11+8]
	mov	DWORD PTR [rsp+32], eax
	mov	r9, QWORD PTR pIrpStack$29085[rsp]
...
; 474  : 		"%s %s\n\n",__DATE__, __TIME__);
	...
	lea	rax, OFFSET FLAT:??_C@_08GLMBMFBO@11?305?340?$AA@FNODOBFM@
	mov	QWORD PTR [rsp+32], rax
